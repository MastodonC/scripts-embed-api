    ...
    for name in codes:
        if name in entities.keys():
            ...
            if existing_devices(entities[name], name, user, pw):
                ...
                data = {"readings": [{"unit": "L", "period": "PULSE", "type": "waterConsumption", "alias": "WaterMeter"}], "description": name, "entity_id": entities[name]}
                ...
                if r.status_code == 201:
                    ...
                    url4 = URL + 'entities/%s/devices/%s' % (entities[name], device_id)
                    ...
                    row_dev.append("")
                    print "Achtung! No device created for " + name + "! -> error: ", r.status_code
            ...
            if r2.status_code == 201:
                ...
                data3 = {"readings": [{"unit": "L", "period": "PULSE", "type": "water meter"}], "description": name, "entity_id": ent_id}
    ...
    with open(text_file, 'w') as f:
        ...
        if r.status_code == 200:
            ...
            if len(entities) > 0:
                ...
                for e in entities:
                    f.write("Property: " + e["property_code"] + "\t id: " + e["entity_id"] + "\n")
                    ...
                    if r2.status_code == 200:
                        for d in r2.json():
                            ...
                            for r in d["readings"]:
                                f.write("\t > Device id: " + r["device_id"] + "\n")
                                f.write("\t > Sensor id: " + r["sensor_id"] + "\n")
                    else:
